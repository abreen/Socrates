...
public class FileView {
    ...
    private void $$$setupUI$$$() {
        ...
        rootPanel.add(scrollPane, "textPaneCard");
        textPane = new JTextPane();
        textPane.setEditable(false);
        textPane.setFont(new Font("Monospaced", textPane.getFont().getStyle(), textPane.getFont().getSize()));
        textPane.setMargin(new Insets(2, 5, 2, 5));
        scrollPane.setViewportView(textPane);
        rootPanel.add(curtainPanel, "curtainCard");
        final JPanel panel1 = new JPanel();
        panel1.setLayout(new BorderLayout(0, 0));
        rootPanel.add(panel1, "plainTextPaneCard");
        panel1.add(plainScrollPane, BorderLayout.CENTER);
        ...
        plainScrollPane.setViewportView(textArea);
    }
