...
public class TestControls implements Observer<TestWrapperNode> {
    ...
    private void $$$setupUI$$$() {
        ...
        innerPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10), null));
        final JPanel panel1 = new JPanel();
        panel1.setLayout(new BorderLayout(0, 10));
        panel1.setOpaque(false);
        innerPanel.add(panel1, BorderLayout.CENTER);
        panel1.add(notesScrollPane, BorderLayout.CENTER);
        notes.setEnabled(false);
        notes.setLineWrap(true);
        notes.setRows(8);
        notes.setWrapStyleWord(true);
        notesScrollPane.setViewportView(notes);
        panel1.add(properties, BorderLayout.NORTH);
        ...
        innerPanel.add(panel2, BorderLayout.NORTH);
        description = new JTextArea();
        description.setEditable(false);
        description.setFont(new Font(description.getFont().getName(), description.getFont().getStyle(), 14));
        description.setLineWrap(true);
        description.setOpaque(false);
        description.setRows(3);
        description.setText("(no test selected)");
